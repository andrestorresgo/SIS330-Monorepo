"""
run_pipeline.py — Hemo-Scout Dataset Master Pipeline
======================================================
...
def main():
    ...
    print()
    print("╔" + "═" * 58 + "╗")
    print("║        HEMO-SCOUT — ML Dataset Engineering Pipeline      ║")
    print("║                                                          ║")
    print("║  Building training data for the cardiovascular 1D-CNN    ║")
    print("║  that predicts hypotensive crashes 5 minutes ahead.      ║")
    print("╚" + "═" * 58 + "╝")
    ...
    print()
    print("  📂 Output files:")
    print("     output/hemo_X_train.npy")
    print("     output/hemo_Y_train.npy")
    print("     output/hemo_dataset.zip")
